  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-8 pt-20 overflow-hidden">
      <div className="max-w-[1000px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-12 items-center z-10">
        ...
        >
          <h1 className="text-5xl md:text-[72px] leading-[1.1] md:leading-[1.05] tracking-tight mb-8">
            {lang === 'TR' ? (
              <>
      ...
      <motion.div
        ...
        className="max-w-[1000px] mx-auto w-full px-8 mt-20 flex items-center gap-4 text-muted text-[11px] tracking-widest uppercase z-10"
      >
